		...
		with open(file_, 'r') as f:
			for line in f:
				...
				if "SVTYPE=BND" in line:
					...
					if chr1 != chr2 and ( chr1 in chr_list or chr2 in chr_list) and ( chr1_list[0] != chr2_list[0]) and (chr1_list[0] in chr_list_all and chr2_list[0] in chr_list_all) and (int(pe)+int(sr) > 5):
