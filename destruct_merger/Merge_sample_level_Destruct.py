		...
		with open(file_, 'r') as f:
			for line in f:
				...
				if type_ == 'translocation':
					...
					if (chr1 != chr2) and (chr1 in chr_list or chr2 in chr_list) and (chr1_list[0] != chr2_list[0]) and ((chr1_list[0] in chr_list_all) and (chr2_list[0] in chr_list_all)) and (int(num_reads)+int(num_split) >= 2) and (float(log_likelihood) > -20.0) and (int(template_length_min)>70):
