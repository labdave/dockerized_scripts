...
Rationale: 
What was being used earlier was the median of individual segments in the cytoband. 
...
python get_cyto_cn.py <cyto_bed> <cyto_intersected_seg> <out_file> <sample_name>
"""
import sys
import os
import pandas as pd
